...
The main study outcome (time-to-failure) were presented in a Kaplan-Meier plot.
Time-to-failure were cross-analyzed with all selected categorical variables, including gender, smoking status and joint.
